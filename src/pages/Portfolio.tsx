    ...
    <div className="container py-6">
      ...
      <Card className="p-6">
        <div className="flex items-center justify-between mb-4">
          <h3 className="text-lg font-semibold">Asset Balances & Collateral Status</h3>
          ...
          <table className="w-full">
            <thead className="border-b border-border">
              <tr className="text-left text-sm text-muted-foreground">
                ...
                <th className="p-3 text-center">Collateral Weight</th>
            ...
            <tbody>
              {assets.map((asset) => (
                <tr key={asset.symbol} className="border-b border-border hover:bg-muted/20">
                  ...
                  <td className="p-3 text-center font-mono-numeric">{(asset.collateralWeight * 100).toFixed(0)}%</td>
      ...
      <Card className="p-6 mt-6 bg-primary/5 border-primary/20">
        <div className="flex gap-4">
          ...
          <div>
            <h4 className="font-semibold mb-1">Maximize Capital Efficiency</h4>
            <p className="text-sm text-muted-foreground">
              Your assets can earn passive yield while serving as collateral for trading. Toggle "As Collateral" 
              to include or exclude assets from your margin pool for granular risk management.
            </p>
          </div>
        </div>
      </Card>
